import { facebook, twitter, youtube } from '../images';
    ...
    <footer className="footer">
      <section className="footer__container container">
        <nav className="nav nav--footer">
          <h2 className="footer__title">Music Community</h2>
          <ul className="nav__link nav__link--footer">
            <li className="nav__items">
              <a href="#" className="nav__links">Principal</a>
            </li>
            <li className="nav__items">
              <a href="#" className="nav__links">Contact</a>
            </li>
            <li className="nav__items">
              <a href="#" className="nav__links">Disclaimed</a>
            </li>
            <li className="nav__items">
              <a href="#" className="nav__links">About us</a>
            </li>
          </ul>
        </nav>

        <form className="footer__form" action="https://formspree.io/f/mknkkrkj" method="POST">
          <h2 className="footer__newsletter">Suscríbete </h2>
      ...
      <section className="footer__copy container">
        ...
        <h3 className="footer__copyright">Derechos reservados &copy; Alpha Team</h3>
      </section>
    </footer>
  );
}
